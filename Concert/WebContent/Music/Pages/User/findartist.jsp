...
<!-- ####################################################################################################### -->
  ...
  PreparedStatement ps = connect.prepareStatement("select * from fan_of natural join user where user_id=?;");
...
<div class="wrapper col4">
  <div id="featured_intro">
   ...
   <table>
   <tr>
	<td><a href="<%=request.getContextPath() %>/MusicControl?aredirect=<%=rs.getString(2) %>" ><%=rs.getString(2) %></td>
	</tr>
	<%} %>
   </table>
  	</center>
