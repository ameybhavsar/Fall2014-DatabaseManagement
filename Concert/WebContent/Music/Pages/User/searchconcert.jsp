...
<input type="text" name="concertsearch" placeholder="Search..." required></input><input type="submit" value="Search"></input>
<input type='hidden' name='action' value='searchconcert'></input>
</form>
</b>
</font>
</div>   
