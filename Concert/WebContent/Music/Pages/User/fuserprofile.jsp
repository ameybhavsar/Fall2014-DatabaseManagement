...
<!-- ####################################################################################################### -->
  <%
  String redirect1 = (String)request.getSession().getAttribute("redirection1");
      ...
      <ul>
        ...
        <li><a href="#">CONCERT</a>
          <ul>
            ...
            <li><a href="<%=request.getContextPath()%>/MusicControl?action=addaconcert&uid=<%=u.getUid()%>">ADD A NEW CONCERT</a></li>
          </ul>
        </li>
...
<div class="wrapper col4">
  ...
  <input type="submit" align='center' name="followunfollow" value="FOLLOW">
  <input type = "hidden" name="getfuid" value="<%=redirect1%>">
  <input type = "hidden" name="getuid" value="<%=u.getUid()%>">
  <input type = "hidden" name="action" value="ufollowu">
	<br>
	<br>
  </center>
