...
<!-- ####################################################################################################### -->
  ...
  PreparedStatement ps = connect.prepareStatement("select * from user_follows natural join user where user_id=?;");
...
<div class="wrapper col4">
  ...
  <center>
   <table>
   <tr>
	<td><a href="<%=request.getContextPath() %>/MusicControl?redirect1=<%=rs.getString(2) %>" ><%=rs.getString(2) %></td>
	</tr>
	<%} %>
   </table>
  	</center>
