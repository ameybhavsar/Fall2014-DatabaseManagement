...
<div class="wrapper col4">
 ...
 <h2>
 <center>CONCERTS YOU HAVE ATTENDED</center></h2>
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
	   ...
	   PreparedStatement ps = connect.prepareStatement("select * from concert natural join user_attendsorplans where user_id = ? and concert_time < now()");
	  ps.setString(1, uid);
...
%>
	...
	%>
       ...
       <h2>
 <center>CONCERTS YOU HAVE PLANNED TO ATTENDED</center></h2>
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th>CONCERT ID</th>
	   ...
	   PreparedStatement ps1 = connect.prepareStatement("select * from concert natural join user_attendsorplans where user_id = ? and concert_time > now()");
	  ps1.setString(1, uid);
...
%>
          <tr class="light">
		<td><a href="<%=request.getContextPath() %>/MusicControl?concertid=<%=rs1.getString("concert_id")%>" ><%=rs1.getString("concert_id") %></a></td>
