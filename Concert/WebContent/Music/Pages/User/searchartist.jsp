      ...
      <ul>
        ...
        <li><a href="#">CONCERT</a>
          <ul>
            ...
            <li><a href="#">SEARCH CONCERTS</a></li>
            <li><a href="#">RATE CONCERTS</a></li>
            <li><a href="#">ADD A NEW CONCERT</a></li>
          </ul>
        </li>
...
<div class="wrapper col4">
  <div id="featured_intro">
    ...
    <div class="fl_right">
  	...
  	<font color=black>
  	<b>
 <form name="findpeople" method="post" action="<%=request.getContextPath() %>/MusicControl" >
<input type="text" name="artistsearch" placeholder="Search..." required></input><input type="submit" value="Search"></input>
<input type='hidden' name='action' value='searchartist'></input>
</form>
</b>
</font>
</div>   
