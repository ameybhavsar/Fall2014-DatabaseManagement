...
<!-- ####################################################################################################### -->
  ...
  PreparedStatement ps = connect.prepareStatement("select * from user_follows natural join user where follow_id=?;");
...
<div class="wrapper col4">
  <div id="featured_intro">
   ...
   <table>
   <tr>
	<td><a href="<%=request.getContextPath() %>/MusicControl?redirect=<%=rs.getString(1) %>" ><%=rs.getString(1) %></td>
	</tr>
	<%} %>
   </table>
  	</center>
