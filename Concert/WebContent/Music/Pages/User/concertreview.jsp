...
<!-- ####################################################################################################### -->
 <%
 String concertid = (String)request.getSession().getAttribute("concertrev");
...
<div class="wrapper col4">
  ...
  PreparedStatement ps1 = connect1.prepareStatement("select * from user_comments where concert_id=?;");
...
<div id="comments">
        ...
        <%while(rs1.next()){ %>
          <li class="comment_odd">
            ...
            <div class="submitdate"><a href="#"><%=rs1.getString("comment_time") %></a></div>
            <p><%=rs1.getString("comment_text") %></p>
          </li>
          <%} %>
        </ul>
      </div>
      ...
      <div id="respond">
        <form name="concertreview" method="post" action="<%=request.getContextPath() %>/MusicControl" >
          ...
          <p>
            ...
            &nbsp;
            <input type="hidden" name='action' value='addcomment'></input>
