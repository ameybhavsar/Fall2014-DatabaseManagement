  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li class="last"><a href="<%=request.getContextPath()%>/MusicControl?action=logout">LOGOUT</a></li>
      </ul>
    </div>
    <div id="search">
...
<div class="wrapper col4">
  <div id="featured_intro">
    <div class="fl_right">
      ...
      <div style="width: 158px; border: #000000 1px solid; background-color: #562051; text-align: center; padding: 0px 2px 7px 2px;">
<div style="color: #FFFFFF; font: 13px arial, sans-serif; font-weight: bold; text-align: center; padding: 3px;">
News Feed<br>
</div>
 <iframe id="NewsWindow" seamless src="news_win.jsp" width="150" height="204" marginwidth="0" marginheight="0" frameborder="0" scrolling="no" style="display: block; margin: 0 auto; padding: 0; border: #000000 1px solid;"></iframe>
</div>
    </div>
    <div class="fl_left">
    <h2>Welcome Back</h2>
      <h2><%=" "+user.getUname()%></h2>
      <h3>Profile</h3>
      <p >You are from : <%=""+user.getCity() %> </p>
            <p>We will wish you on <%=""+user.getDob() %></p>
            <p>About Self <%=""+user.getUdetails() %></p>
            <p>Your Current Trust Score : <%=""+user.getScore() %></p>
            <p>Joined Us on :<%=""+user.getDatejoined() %></p>
            <p>Your Last Access : <%=""+user.getLastaccess() %></p>
