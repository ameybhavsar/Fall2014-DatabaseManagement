...
%>
          <tr class="light">
		<td><a href="<%=request.getContextPath() %>/MusicControl?reviewconcertid=<%=rs.getString("concert_id")%>" ><%=rs.getString("concert_id") %></a></td>
		<td><%=rs.getString("artist_id") %></td>
		<td><%= rs.getString("concert_time") %></td>
		<td><%= rs.getString("venue_name")+","+rs.getString("venue_city") %></td>
		<td><%= rs.getString("TicketRange") %></td>
